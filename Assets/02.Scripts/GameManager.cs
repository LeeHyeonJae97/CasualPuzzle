...
public enum GameMode { TimeAttack, Infinity }
    ...
    private void OnGameStarted(GameMode mode)
    {
        switch (mode)
        {
            case GameMode.TimeAttack:
                OnGameStartedTimeAttackMode();
                break;

            case GameMode.Infinity:
                OnGameStartedInfinityMode();
                break;
        }

        void OnGameStartedTimeAttackMode()
        {
            Score = 0;
        ...
        void OnGameStartedInfinityMode()
        {
            Score = 0;
        }
    }
