...
namespace NaughtyAttributes
{
	...
	public class ButtonAttribute : SpecialCaseDrawerAttribute
	{
		...
		public float UpperSpace { get; private set; }
		public float UnderSpace { get; private set; }

		public ButtonAttribute(string text = null, EButtonEnableMode enabledMode = EButtonEnableMode.Always, float upperSpace = 0, float underSpace = 0)
		{
			Text = text;
